...
```js
import { connect, login, unlockMeda. } from "newgrounds.js";

// Is important have your game connected to perfom all actions
connect("your-app-id", "your-encryption-key"); 

// Only if your game is not in newgrounds
// login(); 

// Now you can unlock the medal
unlockMedal(78827);
```